...
export default function JourneyMapView({ onSwitchView }: JourneyMapViewProps) {
  ...
  const [minNodeSize, setMinNodeSize] = useState(70) // Increased minimum node size
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col" ref={containerRef}>
      <div className="bg-white border-b border-gray-200 py-3 px-4">
        <div className="flex items-center">
          {onSwitchView ? (
            <Button variant="ghost" size="sm" className="text-gray-500 hover:text-gray-900 mr-4" onClick={onSwitchView}>
